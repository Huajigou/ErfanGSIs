...
if [[ -f "$tempdir/file_contexts" ]]; then
    ...
    echo "/keyrefuge              u:object_r:rootfs:s0" >> "$tempdir/file_contexts"#!/bin/bash
...
if [[ -f "$tempdir/file_contexts" ]]; then
    ...
    echo "/product.lnk            u:object_r:rootfs:s0" >> "$tempdir/file_contexts"
    echo "/vgc                    u:object_r:rootfs:s0" >> "$tempdir/file_contexts"
    echo "/vgc/.dyn.prop          u:object_r:rootfs:s0" >> "$tempdir/file_contexts"
    echo "/vgc/apps.list          u:object_r:rootfs:s0" >> "$tempdir/file_contexts"
    echo "/vgc/dyn.prop           u:object_r:rootfs:s0" >> "$tempdir/file_contexts"
    echo "/vgc/apps.version       u:object_r:rootfs:s0" >> "$tempdir/file_contexts"
    echo "/vgc/etc/banyeah        u:object_r:rootfs:s0" >> "$tempdir/file_contexts"
    echo "/vgc/etc                u:object_r:rootfs:s0" >> "$tempdir/file_contexts"
    echo "/vgc/apps.list.sig      u:object_r:rootfs:s0" >> "$tempdir/file_contexts"
    echo "/vgc/lost\+found        u:object_r:rootfs:s0" >> "$tempdir/file_contexts"
    echo "/system-other-odex-marker u:object_r:rootfs:s0" >> "$tempdir/file_contexts"
    echo "/logdump                u:object_r:rootfs:s0" >> "$tempdir/file_contexts"
    echo "/opconfig              u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/opcust                u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/my_bigball            u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/my_product           u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/my_region            u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/my_stock            u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/my_preload          u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/my_carrier           u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/my_company          u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/my_custom          u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/my_engineering         u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/my_heytap          u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/my_manifest         u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/my_version          u:object_r:system_file:s0" >> "$tempdir/file_contexts"
    echo "/special_preload         u:object_r:system_file:s0" >> "$tempdir/file_contexts"
